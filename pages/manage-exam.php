            ...
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        <div>MANAGE EXAM
                            <a href="add-exam.php"
           class="btn btn-dark">Add Exam</a></div>
                    </div>
                </div>
            </div>        
            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-header">QUIZ AND ExAM List</div>
                                ...
                                if($selExam->rowCount() > 0)
                                {
                                    while ($selExamRow = $selExam->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                    $Classes_id =  $selExamRow['grade_id'];
                                                    $selCourse = $conn->query("SELECT * FROM class WHERE Classes_id='$Classes_id' ");
                                                    while ($selCourseRow = $selCourse->fetch(PDO::FETCH_ASSOC)) {
                                                        echo $selCourseRow['grade_code'];
                                                    }
                                                ?>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                             ...
                                             <button type="button" id="deleteExam" action="./deleteExamExe.php" data-id='<?php echo $selExamRow['ex_id']; ?>'  class="btn btn-danger btn-sm">Delete</button>
                                            </td>
                                        </tr>
